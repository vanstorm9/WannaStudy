...
<html lang="en">
  <head>
    ...
    <title>Create your WannaStudy Account</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" name='registration' method='post' action='register_back.php'>
        <h2><font style='color:#FAFAFA;'>Register a WannaStudy Account</font></h2>
		...
		<select class="form-control" name='class_box'>
			<option value="No" disabled selected>You're in the Class of. . .</option>
		...
		<table class='table'>
		<td><input type="radio" name="gender" value="Male"><font style='color:#FAFAFA;'>Male</font><br></td>
		<td><input type="radio" name="gender" value="Female"><font style='color:#FAFAFA;'>Female</font></td>
		</table>		
